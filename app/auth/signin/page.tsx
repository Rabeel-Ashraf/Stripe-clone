/*
  ...
  Email + password form with rate limit indicator
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        // In a real implementation, you'd get rate limit info from the API
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {rateLimitInfo && rateLimitInfo.isLocked && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
              <div className="text-sm text-yellow-600">
                Account temporarily locked. Try again in {Math.ceil(rateLimitInfo.remainingTime / 60000)} minutes.
              </div>
            </div>
          )}
          ...
          <div>
            <button
              type="submit"
              disabled={loading || (rateLimitInfo?.isLocked ?? false)}
